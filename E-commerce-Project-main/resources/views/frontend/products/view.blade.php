        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <hr>
                    <label for="" class="me-3">Valor original  : <s>Rs {{$product->original_price}}</s></label>
                    <label for="" class="fw-bold">Preço de venda : Rs {{$product->selling_price}}</label>
                    <p class="mt-3">
                    ...
                    <hr>
                    @if($product->qty > 0)
                        <label for="" style="background:rgba(234,88,11,255); color:white;" class="badge">Em estoque</label>
                    @else
                        <label for="" class="badge bg-danger">Fora de estoque</label>
                    @endif
                    <div class="row mt-2">
                        <div class="col-md-2">
                            <input type="hidden" value="{{$product->id}}" class="prod_id">
                            <label for="quantity">Qualidade</label>
                        ...
                        <div class="col-md-10">
                            <br/>
                            @if($product->qty > 0)
                            <button class="btn btn-outline-primary me-3 float-start addToCartButton">Adicionar ao carrinho <i class="fa-solid fa-cart-plus"></i></button>
                            @endif
                        </div>
                    </div>
                </div>
