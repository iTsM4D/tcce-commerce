...
<section class="mb-4">
    ...
    <!--Section description-->
    <p class="text-center w-responsive mx-auto mb-5">Você tem alguma dúvida? Por favor, não hesite em nos contatar diretamente. Nossa equipe retornará para você dentro
    ...
    <div class="row">
        ...
        <div class="col-md-9 mb-md-0 mb-5">
            ...
            <div class="text-center text-md-left">
                <a class="w-100 p-2 message btn btn-outline-primary" type="button">ENVIAR MENSAGEM</a>
            </div>
        ...
        <div class="col-md-3 text-center">
            <ul class="list-unstyled mb-0">
                <li><i class="fas fa-map-marker-alt fa-2x"></i>
                    <p>Av. Ângelo Moreira da Fonseca</p>
                </li>
                ...
                <li><i class="fas fa-envelope mt-4 fa-2x"></i>
                    <p>megadermaumuarama@gmail.com</p>
                </li>
            </ul>
        </div>
        <!--Grid column-->
