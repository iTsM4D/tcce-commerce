    ...
    <div class="card shadow mycartitems ">
        ...
        <div class="card-body">
            ...
            <div class="row product_data border-bottom border-light my-4 d-flex justify-content-around align-items-center " >
                ...
                <div class="col-md-2">
                    <button class="btn btn-outline-danger deleteCartItem"><i class="fa fa-trash"></i>Deletar</button>
                </div>
            </div>
        ...
        <div class="card-footer d-flex flex-column">
            <div class="d-flex align-items-center justify-content-end text-center">
                <h6 class="float-end">Valor Total : RS {{$total}}</h6>
            </div>
            <hr>
            <div class="d-flex align-items-center justify-content-end">
                <a href="{{url('checkout')}}" class="btn btn-outline-success float-end ">Confira</a>
            </div>
        </div>
       
        @else   
        <div class="card-body d-flex align-items-center justify-content-center flex-column">
            <h2 class="p-2 m-1">Seu <i class="fa fa-shopping-cart"></i>O carrinho está vazio</h2>
            <a href="{{url('category')}}" class="btn p-2 m-1 btn-outline-primary float-end">Continuar comprando</a>
        </div>
        @endif
    </div>
    <div class="py-5">
