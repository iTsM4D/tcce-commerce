<nav class="navbar navbar-expand-lg navbar-default navbar-dark fixed-top">
  <div class="container-fluid  navbar-default ">
     <a class="navbar-brand" href="{{url('/')}}">Megaderma</a>
     ...
     <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav ms-auto">
           <a class="nav-link px-3 active" aria-current="page" href="/">Pagina Principal</a>
           <a class="nav-link  px-3 " href="{{url('category')}}">Categorias</a>
           <a class="nav-link  px-3 " href="{{url('contact')}}">Contato</a>
           <a class="nav-link  px-3 " href="{{url('about')}}">Sobre</a>
        </div>
